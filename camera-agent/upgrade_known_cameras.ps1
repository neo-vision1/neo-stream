...
$newConfig = [ordered]@{
    ...
    cameras = @(
        ...
        [ordered]@{ id = "CAM11"; name = "iM7+ Zoom Full Color"; ip = "192.168.1.108"; ptzProtocol = "onvif"; onvifPort = 80; onvifAdjustTime = $true; onvifPasswordDigest = $false; username = "admin"; password = $im7Password; supportsZoom = $true }
    )
}
